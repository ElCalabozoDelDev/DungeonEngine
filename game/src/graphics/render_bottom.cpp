...
void RenderBottom::draw(entt::registry& registry, AABB cameraView, float offsetX, float offsetY) {
    ...
    Renderer::renderTiles(registry, visibleBottomTiles, offsetX, offsetY);
}