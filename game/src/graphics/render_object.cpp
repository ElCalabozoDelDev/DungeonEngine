...
void RenderObject::draw(entt::registry& registry, AABB cameraView, float offsetX, float offsetY, float zoomLevel) {
    ...
    Renderer::renderSprites(registry, visibleSprites, offsetX, offsetY, zoomLevel);
}