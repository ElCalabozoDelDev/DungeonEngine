...
void RenderObject::draw(entt::registry& registry, AABB cameraView, float offsetX, float offsetY) {
    ...
    Renderer::renderSprites(registry, visibleSprites, offsetX, offsetY);
}