...
//     {
//         nodes[i].box.setLeft(originDistribution(generator));
//         nodes[i].box.setTop(originDistribution(generator));
//         nodes[i].box.setWidth(std::min(1.0f - nodes[i].box.getLeft(), sizeDistribution(generator)));
//         nodes[i].box.setHeight(std::min(1.0f - nodes[i].box.getTop(), sizeDistribution(generator)));
//         nodes[i].id = i;
//     }
//     return nodes;
// }
