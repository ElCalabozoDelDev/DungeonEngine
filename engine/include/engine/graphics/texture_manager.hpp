#ifndef DE_GRAPHICS_TEXTURE_MANAGER_HPP
#define DE_GRAPHICS_TEXTURE_MANAGER_HPP
...
public:
    ...
    void drawFrame(std::string id, int x, int y, int width, int height,
                   ...
                   double angle, int alpha, float zoomLevel,
                   SDL_RendererFlip flip = SDL_FLIP_NONE);
...
#endif // DE_GRAPHICS_TEXTURE_MANAGER_HPP
